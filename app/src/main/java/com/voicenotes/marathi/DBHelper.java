...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static abstract class DBHelperItem implements BaseColumns {
        ...
        public static final String COLUMN_NAME_TRANS = "transcription";
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + DBHelperItem.TABLE_NAME + " (" +
                    ...
                    DBHelperItem.COLUMN_NAME_TRANS + TEXT_TYPE + COMMA_SEP+
    ...
    public RecordingItem getItemAt(int position) {
        ...
        String[] projection = {
                ...
                DBHelperItem.COLUMN_NAME_TRANS,
        ...
        if (c.moveToPosition(position)) {
            ...
            item.setTrans(c.getString(c.getColumnIndex(DBHelperItem.COLUMN_NAME_TRANS)));
            c.close();
            return item;
        }
        return null;
    ...
    {
        SQLiteDatabase db = getWritableDatabase();
        db.execSQL("DELETE FROM saved_recordings");
    ...
    public int getCount() {
        ...
        Cursor c = db.query(DBHelperItem.TABLE_NAME, projection, null, null, null, null, DBHelperItem.COLUMN_NAME_RECORDING_FILE_PATH+" "+"DESC");
...
//    }
    ...
    public void updatetrans(String txt,String fpath)
    {
        SQLiteDatabase db = getWritableDatabase();
        String strSQL = "update saved_recordings  SET transcription = \""+txt+"\""+" WHERE file_path = "+"\""+ fpath+"\"";
        db.execSQL(strSQL);
        if (mOnDatabaseChangedListener != null) {
            mOnDatabaseChangedListener.onDatabaseEntryUpdated();
        }
//        ContentValues cv = new ContentValues();
//        cv.put(DBHelperItem.COLUMN_NAME_TRANS,txt);
//        db.update(DBHelperItem.TABLE_NAME,cv,DBHelperItem.COLUMN_NAME_RECORDING_FILE_PATH+"="+fpath,null);
    }

    public long addRecording(String recordingName, String filePath, long length,String transcription) {
        ...
        cv.put(DBHelperItem.COLUMN_NAME_TRANS, transcription);
